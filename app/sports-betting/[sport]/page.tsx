...
const sportsData: Record<string, SportDetails> = {
 ...
 "Choose your preferred markets including Live matches, Virtual leagues, or Premium odds charts.",
 "Place bets on 1x2, Full-Time Winners, Over/Under Goals, Corners, or Handicap markets.",
 " comes with enhanced low latency for premium live football action",
 ...
 description: "Kabaddi is India's own indigenous sport which has attracted global attention and markets. Keep a track of Pro Kabaddi League (PKL) and bet on raid points, tackle points and match odds",
 guideTitle: "Kabaddi Tips on Reddy Book",
 guidePoints: [
 ...
 "Register your unique ID configured for high-limits VIP racing pools.",
