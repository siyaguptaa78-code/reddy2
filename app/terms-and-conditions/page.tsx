...
export default function TermsAndConditionsPage() {
 ...
 ⚠️ <b>Warning:</b> Sports and live casino card games involve significant financial risks and the potential for losing your wagers. All bets placed on our platform are at your sole discretion and risk. Reddy Anna Book shall not be held liable for any financial losses or damages incurred.
 </div>
 </div>
