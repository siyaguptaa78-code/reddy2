...
const casinoGamesData: Record<string, GameDetails> = {
 ...
 rulesTitle: "Roulette Odds & Arrays",
 rules: [
 "Pick from our European (single zero) and American (double zero) live roulette feed.",
 "Inside bets offer the thrill of a 36x payout on straight-up numbers; only risk your chips when a single digit, split, or corner.",
 ...
 " rounds are pre-flop, flop, turn, river. Check, fold, call or raise. Best five-card poker hand using your hole cards and the community cards. The best hand rankings include Royal Flush, Straight Flush, Four of a Kind, Full House, etc."
 ]
 },
 "teen-patti": {
