...
export default function ResponsibleGamingPage() {
 ...
 <p>
 At <b>Reddy Anna Book</b>, online and live casino gaming are designed to be an exciting form of recreational entertainment. We are committed to fostering a safe, transparent, and highly supportive environment for all our users.
 </p>
 ...
 ⚠️ <b>Core Principle:</b> should always be treated strictly as a leisure activity, not as a primary source of income or a method to resolve personal financial difficulties. Please stay within your limits and bet responsibly.
 </div>

 {/* Section 1 */}
 <div className="flex flex-col gap-2">
 <h2 className="text-[#c40000] font-rajdhani font-bold text-[20px] uppercase border-l-4 border-[#c40000] pl-3">
 1. Safe Best Practices
 </h2>
 <p>
 ...
 <li><b>Avoid Under Influence:</b> Never place bets or play casino card games under the influence of alcohol, stress, or intense emotional distress.</li>
 </ul>
 </div>
 ...
 <li>Have friends or family members expressed concerns about your activity?</li>
 </ul>
 ...
 <p>
 We enforce a strict <b>18+ age limit</b>. We carry out regular profile checks and reserve the right to freeze any accounts failing to provide clear proof of majority. We advise parents to use filtering software (like Net Nanny or CyberPatrol) to block youth access to sports exchange networks.
 </p>
 </div>
