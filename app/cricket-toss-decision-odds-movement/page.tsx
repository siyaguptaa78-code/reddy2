...
export default function CricketTossDecisionPage() {
 ...
 "description": "Between the coin landing and the captain's bat-or-bowl call, cricket markets shift by millions. Here's what drives those 90 seconds of movement — and how sharp bettors position themselves before the announcement.",
 "author": {
 "@type": "Organization",
 ...
 <p>
 Some of the largest single-event odds movements in cricket history have occurred not after a wicket falls or a six is hit, but in the 90 seconds after a captain makes a decision that defies both expectation and logic.
 </p>
 ...
 <p>
 In all three scenarios, the advantage was not in knowing the toss result. It was in knowing what a rational captain should decide in those conditions — and acting before the market fully priced in either the expected or unexpected decision.
 </p>
 </div>
