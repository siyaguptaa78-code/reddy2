...
export const metadata: Metadata = {
 ...
 alternates: {
 canonical: "https://reddyofficial.com/cricket-toss-market",
 },
 openGraph: {
 title: " on the Coin Flip: Inside Cricket's Weirdest, Most Overlooked Market",
 description:
 "Bookmakers offer odds on cricket's coin toss — and most bettors ignore it completely. Here's what the toss market actually tells you, who makes money from it, and why sharp bettors watch it closely.",
 url: "https://reddyofficial.com/cricket-toss-market",
 ...
 width: 1024,
 height: 683,
 alt: " on the Coin Flip: Inside Cricket's Weirdest, Most Overlooked Market",
 },
 ],
 locale: "en_IN",
 type: "article",
...
export default function CricketTossMarketLayout({
 children,
}: Readonly<{
